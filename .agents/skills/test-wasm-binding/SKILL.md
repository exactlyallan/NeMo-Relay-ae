...
description: Build and test the NeMo Relay WebAssembly binding; use this for crates/wasm changes or WebAssembly-facing integration checks
...
6. Add `cargo test -p nemo-relay-wasm` when Rust-only WebAssembly helpers changed.
